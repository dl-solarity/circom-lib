...
describe("Secp256r1 Double test", () => {
  const reverter = new Reverter();
  ...
  it("P(89565891926547004231252920425935692360644145829622209833684329913297188986597,12158399299693830322967808612713398636155367887041628176798871954788371653930) * 2", async () => {
    const proof = await testDouble(
      89565891926547004231252920425935692360644145829622209833684329913297188986597n,
      12158399299693830322967808612713398636155367887041628176798871954788371653930n,
      circuit,
...
describe("Brainpool Double test", () => {
  const reverter = new Reverter();
...
describe("Secp256r1 On Curve test", () => {
  const reverter = new Reverter();
  ...
  it("P(89565891926547004231252920425935692360644145829622209833684329913297188986597,12158399299693830322967808612713398636155367887041628176798871954788371653930) on curve", async () => {
    const proof = await testOnCurve(
      89565891926547004231252920425935692360644145829622209833684329913297188986597n,
      12158399299693830322967808612713398636155367887041628176798871954788371653930n,
      circuit,
  ...
  it("P(89565891926547004231252920425935692360644145829622209833684329913297188986597 + 1,12158399299693830322967808612713398636155367887041628176798871954788371653930 + 1) on curve, should catch error", async () => {
    await testOnCurve(
