...
describe("Secp256k1 generator multiplication test", function () {
  ...
  it("115792089237316195417293883273301227131288926373708328631619254798622859984896 * G", async () => {
...
describe("Scalar point multiplication test", function () {
  ...
  it("2 * (55066263022277343669578718895168534326250603453777594175500187360389116729240; 32670510020758816978083085130507043184471273380659243275938904335757337482424)", async () => {
  ...
  it("115792089237316195417293883273301227131288926373708328631619254798622859984896 * (89565891926547004231252920425935692360644145829622209833684329913297188986597;12158399299693830322967808612713398636155367887041628176798871954788371653930)", async () => {
    await testScalarMult(
...
describe("BrainpoolP256r1 scalar point multiplication test", function () {
  ...
  it("115792089237316195417293883273301227131288926373708328631619254798622859984896 * (52575969560191351534542091466380106041028581718640875237441073011616025668110;24843789797109572893402439557748964186754677981311543350228155441542769376468)", async () => {
...
describe("Precompute scalar point multiplication test", function () {
  ...
  it("4 * (55066263022277343669578718895168534326250603453777594175500187360389116729240; 32670510020758816978083085130507043184471273380659243275938904335757337482424)", async () => {
...
describe("Precompute scalar point multiplication test BrainpoolP256r1", function () {
  ...
  it("115792089237316195417293883273301227131288926373708328631619254798622859984896n * (52575969560191351534542091466380106041028581718640875237441073011616025668110n; 24843789797109572893402439557748964186754677981311543350228155441542769376468n)", async () => {
