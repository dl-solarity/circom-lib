...
export interface SmtVerifierInterface extends Interface {
...
export interface SmtVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): SmtVerifier;
  waitForDeployment(): Promise<this>;

  interface: SmtVerifierInterface;
