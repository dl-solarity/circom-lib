...
export interface Mul2VerifierInterface extends Interface {
...
export interface Mul2Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): Mul2Verifier;
  waitForDeployment(): Promise<this>;

  interface: Mul2VerifierInterface;
