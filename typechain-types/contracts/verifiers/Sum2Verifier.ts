...
export interface Sum2VerifierInterface extends Interface {
...
export interface Sum2Verifier extends BaseContract {
  connect(runner?: ContractRunner | null): Sum2Verifier;
  waitForDeployment(): Promise<this>;

  interface: Sum2VerifierInterface;
